...
class GeminiTransport implements QuestTransport {
  ...
  Map<String, dynamic> _setupMessage({String? resumeHandle}) {
    ...
    return {
      ...
      // Серверний детектор мовлення (VAD) — типові налаштування Google.
      // Спроба знизити чутливість до початку мовлення (START_SENSITIVITY_LOW
      // проти шуму з Bluetooth-мікрофона) скасована на вимогу замовника:
      // лишаємо як є.
