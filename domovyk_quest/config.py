...
class Character:
    ...
    # Хто гравці. Порожньо — типово «дитина 14 років» (усі дитячі квести
    # парку). Для дорослих версій персонажів («Домовичок 18+») вкажи, напр.,
    # «доросла компанія гостей (18+)» — загальні правила квесту тоді
    # звертаються до гравців, а не до дитини, і тон не «лагідний для дитини».
    audience: str = ""
