...
class Character:
    ...
    # застосунок просить його продовжити розповідь наступною частиною
    # (модель сама по себе говорить лише у відповідь). None — вимкнено.
    auto_continue_s: Optional[int] = None
