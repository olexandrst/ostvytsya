...
персонаж оживає, голосом веде квест із кількох випробувань і, коли всі пройдено,
відправляє гравця далі — шукати нову загадку в коморі.
...
│   ├── characters_store.py      # диспетчер: файли чи PostgreSQL (веб-режим сюди й ходить)
...
завжди читає свій файл персонажа напряму з диска Raspberry Pi, незалежно від
