...
| **Голосовий квест** | `▶ Запустити квест` → дозволь мікрофон → говори |
...
Голос Gemini для консолі задається окремим полем — тож один персонаж звучить
своїм голосом у кожному режимі.
