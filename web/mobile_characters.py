...
Видалення НЕ синхронізується свідомо: персонаж, видалений на одному
телефоні, повернеться з сервера на наступному такті. Це прийнятна ціна за
те, що жоден випадковий дотик на одному терміналі не може стерти персонажа
на всьому парку телефонів.
"""
