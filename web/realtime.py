...
GREETING_TRIGGER = (
    "[Службовий сигнал — не читай його вголос. Дитина щойно підійшла до тебе і "
    "мовчки чекає. Негайно почни розмову САМ: привітайся строго за своїм "
    "сценарієм і одразу переходь до першого кроку квесту. Не чекай, поки дитина "
    "заговорить, і не вигадуй власних завдань — веди рівно той квест, що описаний "
    "у твоїх інструкціях.]"
)
